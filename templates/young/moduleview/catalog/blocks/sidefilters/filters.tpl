...
<section class="filterSection">
    ...
    <form method="GET" class="filters" action="{urlmake f=null bfilter=null p=null escape=true}" autocomplete="off">
        {if $param.show_cost_filter}
            ...
            <a href="{urlmake f=null p=null bfilter=null escape=true}" class="onemore cleanFilter{if empty($filters) && empty($basefilters)} hidden{/if}">очистить фильтр</a>
            ...
            <script type="text/javascript">
                $(function() {
                    $('.typeInterval .pluginInput').each(function() {
                        ...
                        $this.jslider($.extend($(this).data('slider'), {
