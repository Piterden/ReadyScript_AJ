...
<body class="{if $router->getCurrentRoute()->getAction()}{$router->getCurrentRoute()->getAction()}--{/if}{$router->getCurrentRoute()->getController()|replace:"\\":"-"|substr:1}{if $app->getBodyClass()!=''} {$app->getBodyClass()}{/if}">
    {$body}
    {* Нижние скрипты *}
