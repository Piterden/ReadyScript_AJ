        ...
        <div class="container">
            ...
            <div class="row banner">
                <div class="col-md-24 text-center">
                    ...
                    {moduleinsert name="\Banners\Controller\Block\Slider" indexTemplate='blocks/slider/slider_bottom.tpl' zone=4}
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="item footerFriendLinks col-md-4">
                    <div class="link">
                        <a href="http://www.auto-jack.com" target="_blank"><img src="{$THEME_IMG}/footer-ajlogo.png" alt="AutoJack" rel="nofollow"></a>
                    </div>
                    <div class="link">
                        <a href="http://www.limo-lady.com" target="_blank"><img src="{$THEME_IMG}/footer-lllogo.png" alt="LimoLady" rel="nofollow"></a>
                    </div>
                </div>
                ...
                <div class="item footerAddress col-md-4">
                    ...
                    <div class="social">
                        <a href="http://vk.com/autojack" target="_blank" rel="nofollow">
                        ...
                        <a href="http://www.facebook.com/autojack.official" target="_blank" rel="nofollow">
                        ...
                        <a href="http://www.youtube.com/user/autojackandlimolady" target="_blank" rel="nofollow">
