...
<div class="box profile container">
    <div class="row">
        <h1 class="col-md-24 text-center">Личный кабинет</h1>
    </div>
    <div class="rel row userMenu">
        <div class="col-md-14 col-md-offset-5">
            <ul class="profileMenu">
                ...
                <li {if $route_id=='wishlist-front-wishlist'}class="act"{/if}><a href="{$router->getUrl('wishlist-front-wishlist')}">Мои желания</a></li>
                {/if}
