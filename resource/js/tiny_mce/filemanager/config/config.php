...
'base_path' => $base_path,
	...
	*/
	'icon_theme' => "ico",
		...
		'image_max_width' => 0,'image_max_height' => 0,'image_max_mode' => 'auto',
	/*
	...
	'image_resizing' => false,'image_resizing_width' => 0,'image_resizing_height' => 0,'image_resizing_mode' => 'auto', // same as $image_max_mode
'image_resizing_override' => false,
		...
		// ******************
		'delete_files' => true,'create_folders' => true,'delete_folders' => true,'upload_files' => true,'rename_files' => true,'rename_folders' => true,'duplicate_files' => true,'copy_cut_files' => true, // for copy/cut files
...
'create_text_files' => false, // only create files with exts. defined in $editable_text_file_exts
		...
		'googledoc_enabled' => false,'googledoc_file_exts' => array('doc','docx','xls','xlsx','ppt','pptx' 
		),
		
		// Preview with Viewer.js
		'viewerjs_enabled' => false,'viewerjs_file_exts' => array('pdf','odt','odp','ods' 
		),
...
'ext_misc' => array('zip','rar','gz','tar','iso','dmg' 
		 ...
		 * *****************
		 */
		'aviary_active' => true,'aviary_apiKey' => "dvh8qudbp6yx2bnp",'aviary_secret' => "m6xaym5q42rpw433",
		 ...
		 * *****************
		 */
		'java_upload' => false,'JAVAMaxSizeUpload' => 200, // Gb
...
return array_merge ( $config, array('MaxSizeUpload' => (( int ) (ini_get ( 'post_max_size' )) < $config['MaxSizeUpload']) ? ( int ) (ini_get ( 'post_max_size' )) : $config['MaxSizeUpload'],'ext' => array_merge ( $config['ext_img'], $config['ext_file'], $config['ext_misc'], $config['ext_video'], $config['ext_music'] ),
		// For a list of options see: https://developers.aviary.com/docs/web/setup-guide#constructor-config
		'aviary_defaults_config' => array('apiKey' => $config['aviary_apiKey'],'apiVersion' => 3,'language' => 'en','theme' => 'light','tools' => 'all' 
		) 
) );
