    ...
    function helperIndex()
    {
        ...
        $helper->setTable(new Table\Element(array(
            'Columns' => array(
                ...
                new \RS\Html\Table\Type\String('id', '№', array('ThAttr' => array('width' => '50'), 'Sortable' => SORTABLE_BOTH, 'href' => $this->router->getAdminPattern(null, array(':id' => '@id'), 'support-supportctrl'))),
