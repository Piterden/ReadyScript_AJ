...
class File extends \RS\Orm\OrmObject
{
    ...
    function _init()
    {
        parent::_init()->append(array(
            ...
            'servername' => new Type\String(array(
            ...
            'size' => new Type\String(array(
                'description' => t('Размер файла'),
                'visible' => false
            )),
            'mime' => new Type\String(array(
                'description' => t('Mime тип файла'),
                'visible' => false
            )),
            'access' => new Type\String(array(
            ...
            'link_type_class' => new Type\String(array(
            ...
            'uniq' => new Type\String(array(
                'description' => t('Уникальный идентификатор'),
                'visible' => false,
                'maxLength' => 32,
                'unique' => true
            )),
            'uniq_name' => new Type\String(array(
