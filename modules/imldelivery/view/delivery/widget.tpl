...
<div class="infoContainer{$delivery.id}">
    <select id="selectRegionCombo" data-ajax-action="{$router->getUrl('imldelivery-front-ajaxctrl')}" onchange="return initIML_Map(this.value);" data-service-id="{$service_id}" data-region-from="{$region_id_from}"></select>
