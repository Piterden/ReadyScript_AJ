...
class Handlers extends \RS\Event\HandlerAbstract
{
	...
	function init()
	{
		$this->bind ( 'orm.init.shop.order' )->bind ( 'delivery.gettypes' )->bind ( 'getroute' )-> // событие сбора маршрутов модулей
bind ( 'getmenus' ); // событие сбора пунктов меню для административной панели
	...
	{
		$routes[] = new \RS\Router\Route ( 'imldelivery-front-ajaxctrl', array('/imldelivery/' 
	...
	{
		$items[] = array('title' => 'Пункт модуля Imldelivery','alias' => 'imldelivery-control','link' => '%ADMINPATH%/imldelivery-control/','parent' => 'modules','sortn' => 40,'typelink' => 'link' 
		);
		return $items;
	}
