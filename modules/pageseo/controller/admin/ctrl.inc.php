...
class Ctrl extends \RS\Controller\Admin\Crud
{
	...
	function helperIndex()
	{
		...
		$helper->setTable ( new Table\Element ( array('Columns' => array(new TableType\Checkbox ( 'id' ),new TableType\String ( 'description', t ( 'Страница' ) ),new TableType\Usertpl ( 'routeview', t ( 'Маршрут' ), $this->mod_tpl . 'pageseo_column_route.tpl', array('hidden' => true 
