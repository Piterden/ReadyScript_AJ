...
{
	protected static $controller_title = 'Меню', $controller_description = 'Отображает публичные пункты меню';
	protected $default_params = array('indexTemplate' => 'blocks/menu/hor_menu.tpl','root' => 0 
	);
	function getParamObject()
	{
		return parent::getParamObject ()->appendProperty ( array('root' => new Type\String ( array('description' => 'Какой элемент принимать за корневой?','list' => array(array('Menu\Model\Api','selectList' 
		) 
		) 
		) ) 
		) );
