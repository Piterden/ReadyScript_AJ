<?php
namespace Wishlist\Controller\Block; //Задаем пространство имен, соответствующее пути к файлу, относительно папки /modules
use \RS\Orm\Type;
...
{
    protected static
        $controller_title = 'Количество желаний пользователя', //Краткое название контроллера
        $controller_description = 'Отображает количество желаний пользователя'; //Описание контроллера
    
    protected
        $default_params = array(
            'indexTemplate' => 'blocks/wishescount/list.tpl',
            'pageSize' => '5'
        );
    ...
    */
    function actionIndex()
    {
        ...
        $this->view->assign(array(
            'wishCount' => $this->api->getListCount(),
            'wishList' => $this->api->getList()
        ));
