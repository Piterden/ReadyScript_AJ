...
{
	protected static $controller_title = 'Список товаров прикреплённых к статье', $controller_description = 'Отображает N товаров прикреплённых к статье';
	protected $default_params = array('indexTemplate' => 'blocks/article/products.tpl' 
	);
	public $api;
