...
{
	protected static $controller_title = 'Список категорий статей', $controller_description = 'Отображает список категорий статей';
	public $api;
	protected $pathids = array(), $default_params = array('indexTemplate' => 'blocks/category/category.tpl','root' => 0 
	);
	function getParamObject()
	{
		return parent::getParamObject ()->appendProperty ( array('root' => new Type\String ( array('description' => t ( 'Корневая директория' ),'list' => array(array('\Article\Model\CatApi','selectList' 
		) 
		) 
		) ) 
		) );
