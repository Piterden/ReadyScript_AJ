...
class PreviewList extends \RS\Controller\Front
{
	...
	function actionIndex()
	{
		...
		$this->app->title->addSection ( $dir['meta_title'] ?  : $dir['title'] );
		
		$this->app->meta->addKeywords ( $dir['meta_keywords'] )->addDescriptions ( $dir['meta_description'] );
		
		$paginator = new \RS\Helper\Paginator ( $page, $total, $pageSize );
		$this->view->assign ( array('dir' => $dir, // Категория
