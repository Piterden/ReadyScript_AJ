...
class Catapi extends \RS\Module\AbstractModel\TreeCookieList
{
	...
	{
		parent::__construct ( new \Article\Model\Orm\Category (), array('parentField' => 'parent','multisite' => true,'idField' => 'id','aliasField' => 'alias','nameField' => 'title','sortField' => 'sortn','defaultOrder' => 'sortn' 
		) );
	}
	...
	static function selectList($include_root = true)
	{
		...
		return $include_root ? array('' => 'Верхний уровень' 
		) + $list : $list;
	}
	...
	function listWithAll()
	{
		...
		array_unshift ( $tree, array('fields' => array('noOtherColumns' => true,'noCheckbox' => true,'noDraggable' => true,'noFullValue' => true,'title' => t ( 'Все' ),'id' => 0,'alias' => '' 
		),'child' => array() 
		) );
		return $tree;
	}
