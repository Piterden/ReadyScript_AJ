    ...
    function helperIndex()
    {
        ...
        $helper->setTable(new Table\Element(array(
            'Columns' => array(
                ...
                new TableType\String('message', 'Комментарий'),                
                new TableType\String('aid', 'Связь №', array('Sortable' => SORTABLE_BOTH)),
                new TableType\String('ip', 'IP'),                
                new TableType\StrYesno('moderated', 'Промодерированно'),                
                new TableType\String('type_obj_title', 'Тип', array('TdAttr' => array('class' => 'cell-sgray'))),                
            ...
            'container' => new Filter\Container( array( 
                                'lines' =>  array(
                                    new Filter\Line( array('items' => array(
                                                            ...
                                                            new Filter\Type\String('aid','Связь №'),
