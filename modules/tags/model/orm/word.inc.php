...
{
	protected static $table = 'tags_words';
	function _init()
	{
		return $this->getPropertyIterator ()->append ( array('id' => new Type\Bigint ( array('autoincrement' => true,'allowEmpty' => false,'primaryKey' => true,'visible' => false 
		) ),'stemmed' => new Type\String ( array('description' => t ( 'Тег без окончания' ),'index' => true 
		) ),'word' => new Type\String ( array('description' => t ( 'Тег' ) 
		) ),'alias' => new Type\String ( array('description' => t ( 'Английское название тега' ),'unique' => true 
		) ) 
		) );
	}
