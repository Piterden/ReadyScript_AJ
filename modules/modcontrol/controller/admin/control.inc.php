...
{   
    ...
    function helperIndex()
    {
        ...
        $helper->setTable(new Table\Element(array(
            'Columns' => array(
                ...
                new TableType\String('name', 'Название', array(
                    'href' => $this->router->getAdminPattern('edit', array(':mod' => '@class'))
                )),
                new TableType\String('description', 'Описание'),
                new TableType\String('version', 'Версия', array('TdAttr' => array('class'=> 'cell-small'))),                
                new TableType\Usertpl('enabled', 'Включен', '%modcontrol%/col_enabled.tpl'),
                new TableType\String('class', 'Идентификатор', array('ThAttr' => array('width' => '50'))),
            ...
            'container' => new Filter\Container( array( 
                                'lines' =>  array(
                                    new Filter\Line( array('items' => array(
                                                            new Filter\Type\String('name','Название'),
                                                            new Filter\Type\String('class','Идентификатор'))
                                                        )
                                    ))
                                )
                            ))
    ...
    */
    ...
    {        
        ...
        $helper->setBottomToolbar(new Toolbar\Element( array(
            'Items' => array(
                'next' => new ToolbarButton\SaveForm($this->router->getAdminUrl('addStep3'), t('установить'), array('attr' => array('class' => 'saveform'))),
