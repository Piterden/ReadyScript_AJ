    ...
    function helperIndex()
    {
        ...
        $collection->setTable(new Table\Element(array(
            'Columns' => array(
                ...
                new TableType\String('link', 'Ссылка'),
                new TableType\String('weight', 'Вес', array('Sortable' => SORTABLE_BOTH)),
        ...
        $collection->setTree(new Tree\Element( array(
            ...
            'sortable' => false,
            'mainColumn' => new TableType\String('title', 'Название', array('href' => $this->router->getAdminPattern(false, array(':zone' => '@id')))),
