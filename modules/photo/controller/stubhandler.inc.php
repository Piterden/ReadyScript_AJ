...
{
	protected $pic_id_orig, 

	$srcFolder = '', $dstFolder = '/storage/photo/stub/resized';
	function parseParameters()
	{
		...
		$theme_full_path = \Setup::$SM_RELATIVE_TEMPLATE_PATH . '/' . $this->scale . \Setup::$IMG_PATH . trim ( \Setup::$NOPHOTO_THEME_PATH, '/' );
	...
	function exec()
	{
		...
		$img->setQuality ( 97 );
		$url = $img->buildImage ( $this->pic_id, $this->width, $this->height, 'axy', $this->scale );
