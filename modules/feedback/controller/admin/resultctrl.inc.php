    ...
    function helperIndex()
    {
        ...
        $collection->setTable(new Table\Element(array(
            'Columns' => array(
                ...
                new TableType\String('title', 'Название', array('href' => $this->router->getAdminPattern('edit', array(':id' => '@id')), 'LinkAttr' => array('class' => 'crud-edit'))),                
                new TableType\String('dateof', 'Дата создания'),
                new TableType\String('status', 'Статус', array('Sortable' => SORTABLE_BOTH, 'CurrentSort' => SORTABLE_ASC)),
                new TableType\String('id', '№'),                
