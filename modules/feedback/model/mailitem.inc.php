...
class MailItem
{
	private $table_data, // Значения для таблицы уже преобразованные
$php_mailer, // Объект класса отправки PHPMailer
$form, // Объект формы
$mail; // Массив значений формы
	public $host_title, // Название сайта
$host; // Хост сайта
	 ...
	 * @return MailItem
	 */
	function __construct($form, $mail)
	{
		$this->form = $form;
		$this->mail = $mail;
		...
		$this->php_mailer->Subject = $form['subject']; // Тема письма
	...
	{
		if (isset ( $field_data['value']['name'] )) {
