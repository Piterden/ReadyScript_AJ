...
class Handlers extends \RS\Event\HandlerAbstract
{
		...
		if ($site !== false && $site['redirect_to_main_domain']) {
			...
			if ($domains) {
				...
				if ($current_domain != $domains[0]) {
					...
					\RS\Application\Application::getInstance ()->headers->addHeader ( 'location', $new_url )->sendHeaders ();
	...
	{
		$items[] = array('title' => 'Настройка сайта','alias' => 'siteoptions','link' => '%ADMINPATH%/site-options/','parent' => 'website','sortn' => 60,'typelink' => 'link' 
		);
		$items[] = array('title' => 'Сайты','alias' => 'sites','link' => '%ADMINPATH%/site-control/','parent' => 'control','sortn' => 4,'typelink' => 'link' 
		);
