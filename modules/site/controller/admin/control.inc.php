    ...
    function helperIndex()
    {
        ...
        $helper->setTable(new Table\Element(array(
            'Columns' => array(
                ...
                new TableType\String('title', t('Название'), array('Sortable' => SORTABLE_BOTH,'LinkAttr' => array('class' => 'crud-edit'), 'href' => $this->router->getAdminPattern('edit', array(':id' => '@id')) )),
                new TableType\String('domains', t('Доменные имена'),array('Sortable' => SORTABLE_BOTH)),
                new TableType\String('language', t('Язык')),
                ...
                new TableType\Actions('id', array(
                        ...
                        new TableType\Action\DropDown(array(
                            array(
                                'title' => 'Редактировать файл robots.txt',
                                'attr' => array(
                                    'class' => 'crud-edit',
