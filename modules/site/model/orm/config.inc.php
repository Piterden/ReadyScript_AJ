...
class Config extends \RS\Orm\AbstractObject
{
    ...
    function _init()
    {
        $this->getPropertyIterator()->append(array(
            ...
            t('Основные'),
                    'admin_email' => new Type\String(array(
                        'maxLength' => '150',
                    ...
                    'admin_phone' => new Type\String(array(
                        'maxLength' => '150',
            ...
            t('Социальные ссылки'),
                    'facebook_group' => new Type\String(array(
                        'description' => t('Ссылка на группу в Facebook')
                    )),
                    'vkontakte_group' => new Type\String(array(
                        'description' => t('Ссылка на группу ВКонтакте')
                    )),
                    'twitter_group' => new Type\String(array(
