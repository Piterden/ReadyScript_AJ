...
class SectionPage extends \RS\Orm\OrmObject
{
    ...
    function _init()
    {
        ...
        $this->getPropertyIterator()->append(array(
            ...
            'route_id' => new Type\String(array(
                'maxLength' => '255',
                'allowempty' => false,
            ...
            'context' => new Type\String(array(
                'maxLength' => 32,
                'description' => 'Дополнительный идентификатор темы',
                'visible' => false
            )),
            'template' => new Type\String(array(
                'maxLength' => '255',
                'description' => t('Шаблон'),
                'template' => '%templates%/form/sectionpage/template.tpl'
            )),
