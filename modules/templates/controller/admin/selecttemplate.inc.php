...
class SelectTemplate extends \RS\Controller\Admin\Front
{
	...
	function actionIndex()
	{
		...
		$list = $this->api->getFileList ( $path, array('tpl' 
		), $only_themes );
		
		$this->view->assign ( array('root_sections' => $this->api->getRootSections ( $only_themes ), // Корневые рубрики
'allow_edit_ext' => $this->api->getAllowEditExtensions (),'list' => $list,'only_themes' => $only_themes,'start_struct' => $struct 
		) );
