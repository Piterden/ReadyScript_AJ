...
class TransactionCtrl extends \RS\Controller\Admin\Crud
{
    ...
    function helperIndex()
    {
        ...
        $helper->setTable(new Table\Element(array(
            'Columns' => array(
                new TableType\String('id', t('№'), array('Sortable' => SORTABLE_BOTH, 'CurrentSort' => SORTABLE_DESC) ),
                new TableType\Usertpl('user_id', t('Пользователь'), '%shop%/order_user_cell.tpl'),
                new TableType\String('reason', t('Назначение')),
             ...
             'Container' => new Filter\Container( array( 
                                'Lines' =>  array(
                                    new Filter\Line( array('Items' => array(
                                            ...
                                            new Filter\Type\String('cost', t('Сумма'), array('showtype' => true))
                                        )
                                    )),
