    ...
    function helperIndex()
    {
        ...
        $helper->setTable(new Table\Element(array(
            'Columns' => array(
                ...
                new TableType\String('product_title', t('Товар'), array('href' => $this->router->getAdminPattern('edit', array(':id' => '@id') ), 'LinkAttr' => array('class' => 'crud-edit') )),
                new TableType\String('amount', t('Количество')),
                new TableType\String('phone', t('Телефон')),
                new TableType\String('email', t('E-mail')),
                new TableType\String('dateof', t('Дата'), array('Sortable' => SORTABLE_BOTH, 'href' => $this->router->getAdminPattern('edit', array(':id' => '@id') ), 'LinkAttr' => array('class' => 'crud-edit') )),
                new TableType\String('status', t('Статус')),
            ...
            'Container' => new Filter\Container( array( 
                                'Lines' =>  array(
                                    new Filter\Line( array('items' => array(
                                                            new Filter\Type\String('product_id','ID товара'),
                                                            new Filter\Type\String('email','E-mail', array('SearchType' => '%like%')),
