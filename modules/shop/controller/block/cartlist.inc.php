...
class Cartlist extends \RS\Controller\StandartBlock
{
	...
	function actionIndex()
	{
		...
		$this->view->assign ( array('order' => $this->order,'cart' => $this->cart,'cart_products' => $cart_products,'cart_items' => $cart_items,'currency' => \Catalog\Model\CurrencyApi::getCurrentCurrency () 
		) );
