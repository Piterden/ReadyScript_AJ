...
class RegionApi extends \RS\Module\AbstractModel\TreeList
{
	...
	protected static $cache_default_region;
	function __construct()
	{
		parent::__construct ( new \Shop\Model\Orm\Region (), array('parentField' => 'parent_id','nameField' => 'title','defaultOrder' => 'parent_id, title','multisite' => true 
		) );
	}
	static function selectList()
	{
		...
		return array(0 => t ( 'Верхний уровень' ) 
		) + $_this->getAssocList ( $_this->id_field, $_this->name_field );
	}
	...
	static function getDefaultRegion()
	{
		...
		$def_reg = \Shop\Model\Orm\Region::loadByWhere ( array('site_id' => \RS\Site\Manager::getSiteId (),'title' => self::DEFAULT_REGION_NAME 
		) );
