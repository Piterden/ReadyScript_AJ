...
class Delivery extends \RS\Orm\OrmObject
{
     ...
     * @return string
     */
    public function getAddittionalHtml(\Shop\Model\Orm\Order $order = null)
    {
        /*
         *
     ...
     * @return \Shop\Model\DeliveryType\AbstractType
     */
    public function getDeliveryCostText(
        Order $order,
        Address $address = null
    )
    {
    ...
    public function getDeliveryExtraText(
        Order $order,
        Address $address = null
    )
    {
