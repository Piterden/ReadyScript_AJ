...
class DiscountApi extends \RS\Module\AbstractModel\EntityList
{
	...
	{
		parent::__construct ( new \Shop\Model\Orm\Discount (), array('multisite' => true 
		) );
	}
	...
	function save($id = null, $user_post = array())
	{
		...
		if ($id === null && $result && $this->obj_instance['makecount'] > 1) { // Если нужно создать несколько купонов
