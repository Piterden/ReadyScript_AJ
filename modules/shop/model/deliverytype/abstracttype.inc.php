...
/**
 * Абстрактный класс типа доставки.
 * Тип доставки содержит в себе функции для расчета стоимости
...
abstract class AbstractType
{
     ...
     * @return double
     */
    abstract public function getDeliveryCost(\Shop\Model\Orm\Order $order, \Shop\Model\Orm\Address $address = null, $use_currency = true);
     ...
     * @return string
     */
    public function getDeliveryExtraText(\Shop\Model\Orm\Order $order, \Shop\Model\Orm\Address $address = null, $use_currency = true)
    {}
