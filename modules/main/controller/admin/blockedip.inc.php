    ...
    {  
        ...
        $helper->setTable(new Table\Element(array(
            'Columns' => array(
                    ...
                    new TableType\String('ip', 'IP-адрес', array('Sortable' => SORTABLE_BOTH, 
                    ...
                    new TableType\String('comment', t('Комментарий'), array('Sortable' => SORTABLE_BOTH)),
            ...
            'Container' => new Filter\Container( array( 
                                'Lines' =>  array(
                                    new Filter\Line( array('items' => array(
                                                            new Filter\Type\String('ip', t('IP-адрес'), array('SearchType' => '%like%')),
                                                            new Filter\Type\DateRange('expire', t('Дата разблокировки')),
                                                            new Filter\Type\String('comment', t('Комментарий'), array('SearchType' => '%like%')),
                                                        )
                                    ))
                                ),
                            )),
