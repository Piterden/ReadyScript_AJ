...
{
	protected static $controller_title = 'Главное содержимое страницы', $controller_description = 'Возвращает содержимое главного модуля, который обрабатывает страницу';
