...
{
	protected static $controller_title = 'Произвольный HTML', $controller_description = 'Отображает заданное пользователем содержимое';
	...
	{
		return new \RS\Orm\ControllerParamObject ( new \RS\Orm\PropertyIterator ( array('html' => new Type\Richtext ( array('description' => t ( 'Произвольное содержимое' ) 
		) ) 
		) ) );
	}
