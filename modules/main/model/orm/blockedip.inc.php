...
{   
    ...
    function beforeWrite($flag)
    {
        ...
        if (\Main\Model\BlockedIpApi::isIpInRange($_SERVER['REMOTE_ADDR'], $this['ip'])) {
            return $this->addError(t('Невозможно добавить IP, с которого вы работаете'), 'ip');
        }
