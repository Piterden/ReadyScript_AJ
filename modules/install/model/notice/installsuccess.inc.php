 ...
 * @ingroup Install
 */
class InstallSuccess extends \Alerts\Model\Types\AbstractNotice implements \Alerts\Model\Types\InterfaceEmail
{
	public $data;
	...
	{
		$this->data = array('supervisor_email' => $supervisor_email,'supervisor_password' => $supervisor_password,'admin_section' => $admin_section,'domain' => $domain 
		);
	}
