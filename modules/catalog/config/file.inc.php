...
class File extends \RS\Orm\ConfigObject
{
    ...
    function _init()
    {
        parent::_init()->append(array(
            ...
            'hide_unobtainable_goods' => new Type\String(array(
            ...
            'items_on_page' => new Type\String(array(
            ...
            'list_default_order' => new Type\String(array(
            ...
            'list_default_order_direction' => new Type\String(array(
            ...
            'list_default_view_as' => new Type\String(array(
            ...
            'default_weight' => new Type\Float(array(
            ...
            'default_weight_unit' => new Type\String(array(
            ...
            'cbr_link' => new Type\String(array(
            ...
            t('Обмен данными в CSV'),
                ...
                'csv_offer_product_search_field' => new Type\String(array(
                    'runtime' => false,
                ...
                'csv_offer_search_field' => new Type\String(array(
            ...
            t('Склады'),
                'warehouse_sticks' => new Type\String(array(
