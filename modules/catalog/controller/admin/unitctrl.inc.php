...
class UnitCtrl extends \RS\Controller\Admin\Crud
{
	...
	function helperIndex()
	{
		...
		), array('add' => t ( 'добавить единицу измерения' ) 
		) ) );
		...
		) ),new TableType\String ( 'title', 'Полное название', array('Sortable' => SORTABLE_BOTH,'href' => $this->router->getAdminPattern ( 'edit', array(':id' => '@id' 
		) ),'LinkAttr' => array('class' => 'crud-edit' 
		) 
		) ),new TableType\String ( 'stitle', 'Сокращенное название', array('Sortable' => SORTABLE_BOTH 
