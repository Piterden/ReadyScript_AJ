...
{
	protected $info_title = 'Покупки в 1 клик', $info_description = 'Отображает список заявок на товар';
	function actionIndex()
	{
		...
		$this->view->assign ( array('list' => $oneclick_api->getList ( $page, $pageSize ),'paginator' => $paginator,'filter' => $filter 
		) );
