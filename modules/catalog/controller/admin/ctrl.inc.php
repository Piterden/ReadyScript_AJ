    ...
    function helperIndex()
    {
        ...
        $helper->setTable(new Table\Element(array(
            'Columns' => array_merge(array(
                ...
                new TableType\Text('barcode', 'Артикул', array('Sortable' => SORTABLE_BOTH)),
                new TableType\Text('num', 'Остаток', array('Sortable' => SORTABLE_BOTH, 'hidden' => true)),
                new TableType\Text('dateof', 'Дата поступления', array('Sortable' => SORTABLE_BOTH, 'hidden' => true)),
                new TableType\Text('brand_id', 'Бренд', array('Sortable' => SORTABLE_BOTH, 'hidden' => true)),
            ...
            'Container' => new Filter\Container( array( 
                                'Lines' =>  array(
                                    new Filter\Line( array('Items' => array(
                                                            new Filter\Type\Text('name','Название', array('SearchType' => '%like%', 'attr' => array('style' => 'width:300px'))),
                                                        )
                                    ))
                                ),
                            )),
            ...
            'Container' => new Filter\Container( array( 
                                'Lines' =>  array(
                                    new Filter\Line( array('Items' => array(
                                                            ...
                                                            new Filter\Type\Text('barcode', t('Артикул'), array('SearchType' => '%like%', 'Attr' => array('class' => 'w60'))),
