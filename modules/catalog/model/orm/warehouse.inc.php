        ...
        parent::_init()->append(array(
            t('Основные'),
                    ...
                    'title' => new Type\String(array(
                        ...
                        'Checker' => array('chkEmpty', 'Укажите название склада'),
                        'attr' => array(array(
                    ...
                    'adress' => new Type\String(array(
                        ...
                        'template' => '%catalog%/form/warehouse/adress.tpl',
                        'allowempty' => true,
                        'meVisible' => false,
                    )),
                    ...
                    'work_time' => new Type\String(array(
                        'maxLength' => '255',
                        'description' => t('Время работы'),
                        'allowempty' => true,
                    )),
                    'coor_x' => new Type\Float(array(
                        'maxLength' => '255',
