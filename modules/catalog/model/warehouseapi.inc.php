...
class WareHouseApi extends \RS\Module\AbstractModel\EntityList
{
	...
	{
		parent::__construct ( new \Catalog\Model\Orm\WareHouse (), array('multisite' => true,'defaultOrder' => 'sortn','sortField' => 'sortn' 
		) );
	}
	...
	public static function getDefaultWareHouse()
	{
		...
		if ($default_warehouse === null) {
			$default_warehouse = \Catalog\Model\Orm\WareHouse::loadByWhere ( array('site_id' => \RS\Site\Manager::getSiteId (),'default_house' => 1 
			) );
		}
