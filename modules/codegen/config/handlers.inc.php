...
class Handlers extends \RS\Event\HandlerAbstract
{
	...
	{
		// Добавление кнопки на страницу "Настройка модулей"
		$url = Manager::obj ()->getAdminUrl ( 'generateModule', array(), 'codegen-control' );
		
		if ($helper['topToolbar']) {
			$helper['topToolbar']->addItem ( new Button ( $url, t ( 'сгенерировать новый модуль' ), array('attr' => array('class' => 'crud-add' 
			) 
			) ), 'generate_module' );
		}
	}
