...
class Handlers extends \RS\Event\HandlerAbstract
{
	function init()
	{
		$this->bind ( 'controller.beforewrapoutput' )->bind ( 'getmenus' );
	}
	public static function getMenus($items)
	{
		$items[] = array('title' => 'SEO контроль','alias' => 'seocontrol','link' => '%ADMINPATH%/seocontrol-ctrl/','typelink' => 'link','parent' => 'modules' 
		);
		return $items;
	}
