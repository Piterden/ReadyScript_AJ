    ...
    function helperIndex()
    {
        ...
        $helper->setTable(new Table\Element(array(
            'Columns' => array(
                ...
                new TableType\String('url_pattern', t('Маска URL')),
                new TableType\String('meta_title', t('Заголовок')),
                new TableType\String('meta_keywords', t('Ключевые слова'), array('hidden' => true)),
