...
{
	protected $info_title = 'Проверка обновлений', $info_description = 'Информирует о доступности обновлений для платформы ReadyScript', $action_var = 'cudo';
	public $api;
	function init()
	{
	...
	function actionIndex()
	{
		...
		$this->view->assign ( array('expire_days' => $expire_days,'state' => $state 
		) );
