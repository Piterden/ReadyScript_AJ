        ...
        $this->getPropertyIterator()->append(array(
            t('Основные'),
                    'alias' => new Type\String(array(
                        'maxLength' => '50',
                        'description' => 'Псевдоним(англ.яз)',
                        'primaryKey' => true,
                        'Checker' => array('chkPattern', 'Псевдоним должен состоять из латинских букв и цифр.', '/^[a-zA-Z0-9]+$/'),
                    )),
                    'name' => new Type\String(array(
                        'maxLength' => '100',
                        'description' => 'Название группы',
                        'Checker' => array('chkEmpty','Необходимо заполнить название группы'),
                    )),
