        ...
        $this->getPropertyIterator()->append(array(
            t('Основные'),
                    'name' => new Type\String(array(
                        'maxLength' => '100',
                        'description' => 'Имя',
                        'Checker' => array('chkEmpty', 'Укажите, пожалуйста, имя'),
                    )),
                    'surname' => new Type\String(array(
                        'maxLength' => '100',
                        'description' => 'Фамилия',
                        'Checker' => array('chkEmpty', 'Укажите, пожалуйста, фамилию'),
                    )),
                    'midname' => new Type\String(array(
                        'maxLength' => '100',
                        'description' => 'Отчество',
                    )),
                    'e_mail' => new Type\String(array(
                        'maxLength' => '150',
                        'description' => 'E-mail',
                        'unique' => true,
                        'Checker' => array('chkEmail', 'Неверно заполнен e-mail'),
                    )),
                    ...
                    'openpass' => new Type\String(array(
                        'template' => '%users%/form/user/chpass.tpl',
                        'maxLength' => '100',
                        'description' => 'Новый пароль',
                        'runtime' => true,
                        'Attr' => array(array('size' => '20', 'type' => 'password')),
                        'Checker' => array(array(__CLASS__, 'checkOpenPassword'), '')
                    )),
                    'pass' => new Type\String(array(
                        'maxLength' => '32',
                        'description' => 'Пароль',
                        'Attr' => array(array('size' => '20', 'type' => 'password')),
                        'listenPost' => false,
                    ...
                    'phone' => new Type\String(array(
                        'maxLength' => '50',
                        'description' => 'Телефон',
                        'Checker' => array('chkPattern', 'Неверно указан телефон', '/^[0-9()\-\s+,]+$/'),
                    )),
                    'sex' => new Type\String(array(
                        'maxLength' => '1',
                        'description' => 'Пол',
                        'ListFromArray' => array(array('' => 'Не выбрано', 'M' => 'Мужской', 'F' => 'Женский')),
                        'Attr' => array(array()),
                    )),
                    ...
                    'balance_sign' => new Type\String(array(
                        'visible' => false,
                    ...
                    'ban_reason' => new Type\String(array(
            ...
            t('Организация'),            
                    'is_company' => new Type\Integer(array(
                        ...
                        'ListFromArray' => array(array('0' => 'Нет', '1' => 'Да')),
                    )),
                    'company' => new Type\String(array(
                        'maxLength' => '255',
                        'description' => 'Название организации',
                        'condition' => $for_company,
                        'Checker' => array($chk_depend, 'Не указано название организации', 'chkEmpty', $for_company),
                    )),
                    'company_inn' => new Type\String(array(
                        'maxLength' => '12',
            ...
            t('Группы'),
                '__groups__' => new Type\UserTemplate('%users%/form/user/groups.tpl'),
    ...
    function checkCreateData()
    {
        ...
        if ($res->rowCount()) {
            ...
            if (!empty($this['login']) && stristr($user_row['login'], $this['login']) !== false)
                $this->addError('Пользователь с таким логином уже существует', 'login');
                
            if (!empty($this['e_mail']) && stristr($user_row['e_mail'], $this['e_mail']) !== false)
                $this->addError('Пользователь с таким E-mail`ом уже существует', 'e_mail');            
