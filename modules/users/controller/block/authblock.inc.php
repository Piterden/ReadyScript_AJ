...
{
	protected static $controller_title = 'Блок авторизации', // Краткое название контроллера
$controller_description = 'Отображает ссылки войти/зарегистрироваться или имя текущего пользователя и персональным меню'; // Описание контроллера
	protected $default_params = array('indexTemplate' => 'blocks/authblock/authblock.tpl' 
