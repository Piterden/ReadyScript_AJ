...
{
	protected $info_title = 'Безопасность', $info_description = 'Список последних авторизаций администраторов', $title = 'Недавние авторизации';
	function actionIndex()
	{
		...
		$this->view->assign ( array('list' => $list,'paginator' => $paginator 
		) );
