...
class Ctrlgroup extends \RS\Controller\Admin\Crud
{
    ...
    function helperIndex()
    {
        ...
        $helper->setTable(new Table\Element(array(
            'Columns' => array(
                new TableType\Checkbox('alias', array('ThAttr' => array('width' => 20))),            
                new TableType\String('name', 'Название', array('href' => $this->router->getAdminPattern('edit', array(':id' => '@alias')), 'Sortable' => SORTABLE_BOTH)),
                new TableType\String('description', 'Описание'),
                new TableType\String('alias', 'Псевдоним', array('ThAttr' => array('width' => '50'), 'Sortable' => SORTABLE_BOTH, 'CurrentSort' => SORTABLE_ASC)),                
                new TableType\StrYesno('is_admin', 'Админ'),
    ...
    function actionAdd($primaryKeyValue = null, $returnOnSuccess = false, $helper = null)
    {
        ...
        'Columns' => array(
            new TableType\String('class', 'Модуль', array('TdAttr' => array('align' => 'center'))),
            new TableType\String('name', 'Название'),
            new TableType\String('description', 'Описание'),
            new TableType\Usertpl('access', 'Уровень доступа', '%users%/modright.tpl', array(
        ...
        $admin_tree = new \RS\Html\Tree\Element(array(
                ...
                'sortIdField' => 'alias',
                'activeField' => 'alias',
                'mainColumn' => new TableType\String('title', 'Название', array()),
