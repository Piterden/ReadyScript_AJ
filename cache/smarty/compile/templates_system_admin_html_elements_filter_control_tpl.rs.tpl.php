...
/* %%SmartyHeaderCode:88156866156942ca6d681e6-27311581%% */
if (! defined ( 'SMARTY_DIR' )) exit ( 'no direct access allowed' );
$_valid = $_smarty_tpl->decodeProperties ( array('file_dependency' => array('908ef48d2746d8336a7bd5c237714efe6cdff2f2' => array(0 => '/home/groupvm/www/site22/public_html/templates/system/admin/html_elements/filter/control.tpl',1 => 1452522616,2 => 'rs' 
) 
),'nocache_hash' => '88156866156942ca6d681e6-27311581','function' => array(),'variables' => array('fcontrol' => 0,'key' => 0,'val' => 0,'parts' => 0,'part' => 0 
),'has_nocache_code' => false,'version' => 'Smarty-3.1.18','unifunc' => 'content_56942ca6e02dd7_50635194' 
), false ); /* /%%SmartyHeaderCode%% */
?>
<?php


if ($_valid && ! is_callable ( 'content_56942ca6e02dd7_50635194' )) {
	function content_56942ca6e02dd7_50635194($_smarty_tpl)
	{
		?><?php
...
echo smarty_function_addjs ( array('file' => "filter.js" 
		), $_smarty_tpl );
		?>

<form method="GET" class="filter form-call-update"
	id="<?php echo $_smarty_tpl->tpl_vars['fcontrol']->value->uniq;?>
">
    <?php
...
$_smarty_tpl->tpl_vars['val'] = new Smarty_Variable ();
		...
		$_from = $_smarty_tpl->tpl_vars['fcontrol']->value->getAddParam ( 'hiddenfields' );
...
<?php if (count($_smarty_tpl->tpl_vars['parts']->value)>1) {?><span
		class="part clean_all"><a
		href="<?php echo $_smarty_tpl->tpl_vars['fcontrol']->value->getCleanFilterUrl();?>
"
		class="clean call-update"
...
$_smarty_tpl->tpl_vars['part'] = new Smarty_Variable ();
			$_smarty_tpl->tpl_vars['part']->_loop = false;
...
<a
		href="<?php echo $_smarty_tpl->tpl_vars['part']->value['href_clean'];?>
"
		class="clean call-update"
		title="<?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
