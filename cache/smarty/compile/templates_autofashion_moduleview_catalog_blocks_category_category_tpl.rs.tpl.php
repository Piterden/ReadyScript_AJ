...
/* %%SmartyHeaderCode:20896013456942ca9a1de37-97633533%% */
if (! defined ( 'SMARTY_DIR' )) exit ( 'no direct access allowed' );
$_valid = $_smarty_tpl->decodeProperties ( array('file_dependency' => array('8e17e141a2b9fd3cebdb74253d6cfbf690b4447f' => array(0 => '/home/groupvm/www/site22/public_html/templates/autofashion/moduleview/catalog/blocks/category/category.tpl',1 => 1452548191,2 => 'rs' 
) 
),'nocache_hash' => '20896013456942ca9a1de37-97633533','function' => array(),'variables' => array('dirlist' => 0,'dir' => 0,'pathids' => 0,'cnt' => 0,'columns' => 0,'item' => 0 
),'has_nocache_code' => false,'version' => 'Smarty-3.1.18','unifunc' => 'content_56942ca9aa45d7_82977928' 
), false ); /* /%%SmartyHeaderCode%% */
?>
<?php


if ($_valid && ! is_callable ( 'content_56942ca9aa45d7_82977928' )) {
	function content_56942ca9aa45d7_82977928($_smarty_tpl)
	{
		?><?php
...
$_smarty_tpl->tpl_vars['dir'] = new Smarty_Variable ();
			$_smarty_tpl->tpl_vars['dir']->_loop = false;
			$_from = $_smarty_tpl->tpl_vars['dirlist']->value;
			...
			foreach($_from as $_smarty_tpl->tpl_vars['dir']->key => $_smarty_tpl->tpl_vars['dir']->value) {
				...
				?>
        <li
		class="<?php echo $_smarty_tpl->tpl_vars['dir']->value['fields']['alias'];?>
<?php if (in_array($_smarty_tpl->tpl_vars['dir']->value['fields']['id'],$_smarty_tpl->tpl_vars['pathids']->value)) {?> act<?php }?>"
		<?php echo $_smarty_tpl->tpl_vars['dir']->value['fields']->getDebugAttributes();?>><a
...
"><?php echo $_smarty_tpl->tpl_vars['dir']->value['fields']['name'];?>
            ...
            <?php }?>
            <ul <?php if ($_smarty_tpl->tpl_vars['columns']->value) {?>
			class="<?php echo $_smarty_tpl->tpl_vars['columns']->value;?>
"
			<?php }?>>
                <?php
...
$_smarty_tpl->tpl_vars['item'] = new Smarty_Variable ();
					...
					$_from = $_smarty_tpl->tpl_vars['dir']->value['child'];
					if (! is_array ( $_from ) && ! is_object ( $_from )) {
						settype ( $_from, 'array' );
					}
					foreach($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value) {
						...
						?>
                <li
				<?php if (in_array($_smarty_tpl->tpl_vars['item']->value['fields']['id'],$_smarty_tpl->tpl_vars['pathids']->value)) {?>
				class="act" <?php }?>
				<?php echo $_smarty_tpl->tpl_vars['item']->value['fields']->getDebugAttributes();?>><a
				href="<?php echo $_smarty_tpl->tpl_vars['item']->value['fields']->getUrl();?>
