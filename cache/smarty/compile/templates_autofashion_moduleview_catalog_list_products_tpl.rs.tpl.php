...
/* %%SmartyHeaderCode:198646245156942ca926ab53-16463236%% */
if (! defined ( 'SMARTY_DIR' )) exit ( 'no direct access allowed' );
$_valid = $_smarty_tpl->decodeProperties ( array('file_dependency' => array('321933da4cf2081d53db5d7568abd69cb497920d' => array(0 => '/home/groupvm/www/site22/public_html/templates/autofashion/moduleview/catalog/list_products.tpl',1 => 1452548190,2 => 'rs' 
) 
),'nocache_hash' => '198646245156942ca926ab53-16463236','function' => array(),'variables' => array('shop_config' => 0,'no_query_error' => 0,'category' => 0,'sub_dirs' => 0,'query' => 0,'dir_id' => 0,'one_dir' => 0,'item' => 0,'list' => 0,'view_as' => 0,'total' => 0,'cur_sort' => 0,'cur_n' => 0,'sort' => 0,'can_rank_sort' => 0,'page_size' => 0,'items_on_page' => 0,'current_user' => 0,'product' => 0,'specCategory' => 0,'router' => 0,'THEME_IMG' => 0,'main_image' => 0,'check_quantity' => 0 
),'has_nocache_code' => false,'version' => 'Smarty-3.1.18','unifunc' => 'content_56942ca95139a3_28097630' 
), false ); /* /%%SmartyHeaderCode%% */
?>
<?php


if ($_valid && ! is_callable ( 'content_56942ca95139a3_28097630' )) {
	function content_56942ca95139a3_28097630($_smarty_tpl)
	{
		?><?php
...
echo smarty_function_addjs ( array('file' => "jquery.changeoffer.js" 
		), $_smarty_tpl );
		?>
...
<div class="noQuery">Не задан поисковый запрос</div>
<?php } else { ?>
<div id="products"
	class="productList<?php if ($_smarty_tpl->tpl_vars['shop_config']->value) {?> shopVersion<?php }?><?php if ($_smarty_tpl->tpl_vars['category']->value['level']==0&&$_smarty_tpl->tpl_vars['category']->value['is_spec_dir']=='N') {?> container<?php }?>">
...
$_smarty_tpl->tpl_vars['item'] = new Smarty_Variable ();
				...
				$_from = $_smarty_tpl->tpl_vars['sub_dirs']->value;
			...
			<?php }?>
			<div
			class="col-md-8 subCategory <?php echo $_smarty_tpl->tpl_vars['item']->value['alias'];?>
">
			<div class="wrapper">
				<a
					href="<?php echo smarty_function_urlmake(array('category'=>$_smarty_tpl->tpl_vars['item']->value['_alias'],'p'=>null,'f'=>null,'bfilter'=>null),$_smarty_tpl);?>
"> <img
					src="<?php echo $_smarty_tpl->tpl_vars['item']->value->__image->getUrl(358,528);?>
"
					alt="<?php echo $_smarty_tpl->tpl_vars['item']->value['name'];?>
"> <span class="textBlock"> <span class="wrapper"> <span class="icon"></span>
							<span class="categoryTitle h3"><?php echo $_smarty_tpl->tpl_vars['item']->value['name'];?>
</span> <span class="lookAtAll h5 cornered-border">Смотреть все</span>
					</span>
				</span>
				</a>
			</div>
...
</span> <span class="sort"> Сортировать по <span class="ddList"> <span
					class="value h4"><?php if ($_smarty_tpl->tpl_vars['cur_sort']->value=='dateof') {?>дате<?php } elseif ($_smarty_tpl->tpl_vars['cur_sort']->value=='rating') {?>популярности<?php } else { ?>цене<?php }?> <i
						class="fa fa-sort-<?php echo $_smarty_tpl->tpl_vars['cur_n']->value;?>
"></i></span>
					<ul>
						<li><a
							href="<?php echo smarty_function_urlmake(array('sort'=>"cost",'nsort'=>$_smarty_tpl->tpl_vars['sort']->value['cost']),$_smarty_tpl);?>
"
							class="item<?php if ($_smarty_tpl->tpl_vars['cur_sort']->value=='cost') {?> <?php echo $_smarty_tpl->tpl_vars['cur_n']->value;?>
<?php }?>"
							rel="nofollow">цене</a></li>
						<li><a
							href="<?php echo smarty_function_urlmake(array('sort'=>"rating",'nsort'=>$_smarty_tpl->tpl_vars['sort']->value['rating']),$_smarty_tpl);?>
"
...
<?php }?>"
						...
						<li><a
							href="<?php echo smarty_function_urlmake(array('sort'=>"dateof",'nsort'=>$_smarty_tpl->tpl_vars['sort']->value['dateof']),$_smarty_tpl);?>
"
							class="item<?php if ($_smarty_tpl->tpl_vars['cur_sort']->value=='dateof') {?> <?php echo $_smarty_tpl->tpl_vars['cur_n']->value;?>
<?php }?>"
							rel="nofollow">дате</a></li>
						<li><a
							href="<?php echo smarty_function_urlmake(array('sort'=>"num",'nsort'=>$_smarty_tpl->tpl_vars['sort']->value['num']),$_smarty_tpl);?>
"
...
<?php }?>"
							rel="nofollow">наличию</a></li>
				                    ...
				                    <li><a
							href="<?php echo smarty_function_urlmake(array('sort'=>"rank",'nsort'=>$_smarty_tpl->tpl_vars['sort']->value['rank']),$_smarty_tpl);?>
"
							class="item<?php if ($_smarty_tpl->tpl_vars['cur_sort']->value=='rank') {?> <?php echo $_smarty_tpl->tpl_vars['cur_n']->value;?>
<?php }?>"
							rel="nofollow"><i>релевантности</i></a></li>
				                    <?php }?>                    
				                </ul>
			</span>
			</span> <span class="pageSize"> Показывать по <span class="ddList"> <span
					class="value h4"><?php echo $_smarty_tpl->tpl_vars['page_size']->value;?>
</span>
					<ul>
				                    <?php
...
$_smarty_tpl->tpl_vars['item'] = new Smarty_Variable ();
						$_smarty_tpl->tpl_vars['item']->_loop = false;
						$_from = $_smarty_tpl->tpl_vars['items_on_page']->value;
						if (! is_array ( $_from ) && ! is_object ( $_from )) {
							settype ( $_from, 'array' );
						}
						foreach($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value) {
							...
							?>
				                    <li
							class="<?php if ($_smarty_tpl->tpl_vars['page_size']->value==$_smarty_tpl->tpl_vars['item']->value) {?> act<?php }?>"><a
							href="<?php echo smarty_function_urlmake(array('pageSize'=>$_smarty_tpl->tpl_vars['item']->value),$_smarty_tpl);?>
...
$_smarty_tpl->tpl_vars['product'] = new Smarty_Variable ();
			            ...
			            <div class="col-sm-8 productItem"
...
$_smarty_tpl->tpl_vars['specCategory'] = new Smarty_Variable ();
							$_smarty_tpl->tpl_vars['specCategory']->_loop = false;
							$_from = $_smarty_tpl->tpl_vars['product']->value->getSpecDirs ();
							if (! is_array ( $_from ) && ! is_object ( $_from )) {
								settype ( $_from, 'array' );
							}
						...
						<img
							src="<?php echo $_smarty_tpl->tpl_vars['specCategory']->value->__image->getLink();?>
"
...
">
				...
				<div class="toCartWrap">
			                        <?php if ($_smarty_tpl->tpl_vars['product']->value->isOffersUse()||$_smarty_tpl->tpl_vars['product']->value->isMultiOffersUse()) {?>
			                            <a
						data-href="<?php echo $_smarty_tpl->tpl_vars['router']->value->getUrl('shop-front-multioffers',array("product_id"=>$_smarty_tpl->tpl_vars['product']->value['id']));?>
"
						class="button showMultiOffers inDialog noShowCart"> <img
						src="<?php echo $_smarty_tpl->tpl_vars['THEME_IMG']->value;?>
/cart.png"
						alt="Add to Cart" width="20px" height="20px">
						<div class="toCartText">В корзину</div>
					</a>
			                        <?php } else { ?>
			                            <a
...
"
						class="button addToCart noShowCart" data-add-text="Добавлено"> <img
						src="<?php echo $_smarty_tpl->tpl_vars['THEME_IMG']->value;?>
/cart.png"
						alt="Add to Cart" width="20px" height="20px">
						<div class="toCartText">В корзину</div>
				...
				<a
					href="<?php echo $_smarty_tpl->tpl_vars['product']->value->getUrl();?>
"
					class="mainLink">
					<div class="pic text-center">
						<img
							src="<?php echo $_smarty_tpl->tpl_vars['main_image']->value->getUrl(185,300,'axy');?>
"
...
">
				...
				href="<?php echo $_smarty_tpl->tpl_vars['product']->value->getUrl();?>
"><img
					src="<?php echo $_smarty_tpl->tpl_vars['main_image']->value->getUrl(100,100);?>
"
					alt="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['main_image']->value['title'])===null||$tmp==='' ? ((string)$_smarty_tpl->tpl_vars['product']->value['title']) : $tmp);?>
" /></a></td>
			<td class="info"><a
...
"
				class="title"><?php echo $_smarty_tpl->tpl_vars['product']->value['title'];?>
							...
							<?php if ($_smarty_tpl->tpl_vars['product']->value['barcode']) {?><p
					class="barcode">Артикул: <?php echo $_smarty_tpl->tpl_vars['product']->value['barcode'];?>
</p><?php }?>
			...
			<td class="actions">
							<?php if ($_smarty_tpl->tpl_vars['shop_config']->value) {?>
								<?php if ($_smarty_tpl->tpl_vars['product']->value->shouldReserve()) {?>
									<a
				href="<?php echo $_smarty_tpl->tpl_vars['router']->value->getUrl('shop-front-reservation',array("product_id"=>$_smarty_tpl->tpl_vars['product']->value['id']));?>
"
...
"
				...
				data-href="<?php echo $_smarty_tpl->tpl_vars['router']->value->getUrl('shop-front-cartpage',array("add"=>$_smarty_tpl->tpl_vars['product']->value['id']));?>
"
				class="button addToCart noShowCart" data-add-text="Добавлено">В
					корзину</a>
										<?php }?>                                                                                        
									<?php }?>
								<?php }?>
							<?php }?>
							<a
				class="compare<?php if ($_smarty_tpl->tpl_vars['product']->value->inCompareList()) {?> inCompare<?php }?>"><span>Сравнить</span><span
					class="already">Добавлено</span></a>
			</td>
		</tr>                       
					<?php } ?>
				</table>
