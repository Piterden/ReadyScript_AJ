...
/* %%SmartyHeaderCode:103728391456942ca9e62541-01484246%% */
if (! defined ( 'SMARTY_DIR' )) exit ( 'no direct access allowed' );
$_valid = $_smarty_tpl->decodeProperties ( array('file_dependency' => array('6b916975b8026ee95b1acf06608ee4a3bff576a0' => array(0 => '/home/groupvm/www/site22/public_html/templates/autofashion/html.tpl',1 => 1452548185,2 => 'rs' 
) 
),'nocache_hash' => '103728391456942ca9e62541-01484246','function' => array(),'variables' => array('app' => 0,'css' => 0,'js' => 0,'body' => 0 
),'has_nocache_code' => false,'version' => 'Smarty-3.1.18','unifunc' => 'content_56942ca9f0e7e3_38222172' 
), false ); /* /%%SmartyHeaderCode%% */
?>
<?php if ($_valid && !is_callable('content_56942ca9f0e7e3_38222172')) {function content_56942ca9f0e7e3_38222172($_smarty_tpl) {?>
...
$_smarty_tpl->tpl_vars['css'] = new Smarty_Variable ();
		...
		$_from = $_smarty_tpl->tpl_vars['app']->value->getCss ();
...
$_smarty_tpl->tpl_vars['js'] = new Smarty_Variable ();
		...
		$_from = $_smarty_tpl->tpl_vars['app']->value->getJs ();
		if (! is_array ( $_from ) && ! is_object ( $_from )) {
			settype ( $_from, 'array' );
		}
...
$_smarty_tpl->tpl_vars['js'] = new Smarty_Variable ();
		$_smarty_tpl->tpl_vars['js']->_loop = false;
		$_from = $_smarty_tpl->tpl_vars['app']->value->getJs ( 'footer' );
		if (! is_array ( $_from ) && ! is_object ( $_from )) {
			settype ( $_from, 'array' );
		}
		foreach($_from as $_smarty_tpl->tpl_vars['js']->key => $_smarty_tpl->tpl_vars['js']->value) {
