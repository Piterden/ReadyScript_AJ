...
class Options extends AbstractTool
{
	...
	{
		$this->options['attr'] = array('href' => \RS\Router\Manager::obj ()->getAdminUrl ( 'edit', array('mod' => $mod_name 
		), 'modcontrol-control' ),'title' => t ( 'Настройки модуля' ),'class' => " debug-icon-options",'target' => '_blank' 
		);
