...
class BlockOptions extends AbstractTool
{
	...
	{
		$this->options['attr'] = array('href' => \RS\Router\Manager::obj ()->getAdminUrl ( 'editModule', array('id' => $block_id 
		), 'templates-blockctrl' ),'title' => t ( 'Настройки блока' ),'class' => "crud-add debug-icon-blockoptions",'target' => '_blank' 
		);
