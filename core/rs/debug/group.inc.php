...
class Group
{
	...
	protected static $instance = array(), $counter = 1;
	protected $refresh_url, $actions = array(), $uniq, // Уникальный номер группы.
...
$debug_tools = array();
	...
	function addTool($name, Tool\ToolInterface $tool)
	{
		...
		$this->debug_tools = array($name => $tool 
		) + $this->debug_tools;
	}
	 ...
	 * 
	 * @param array of \RS\Debug\Action\AbstractAction $actions - массив с действиями в для контекстного меню
	 * @param mixed $data - массив с данными для подстановки
	 * @param array | null $additional - дополнительный ассоциативнй массив с параметрами
	 * @return string | null
	 */
