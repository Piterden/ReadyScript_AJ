...
{
	const CONTROLLER_PARAM = 'controller', // GET параметр, который задает имя контроллера
...
DEFAULT_ACTION = 'index'; // Действие контроллера по-умолчанию
	protected $id, $patterns = array(), $match, $defaults = array(), $is_admin = false, $hide = false, $description;
