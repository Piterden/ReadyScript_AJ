...
class FieldChecker
{
	...
	/**
	 * Проверяет, если значение -1, то ошибка. Удобно использовать в SELECT.
	 */
	...
	{
		if (filter_var ( $param, FILTER_VALIDATE_EMAIL ) === false) $this->SetErr ( $errtext, $form );
		return $param;
	}
