...
{
	public $RenderBodyTemplates, $RenderBodyVars;
	protected $EventId, $EventParams = array();
	...
	function preSend()
	{
		...
		$event_result = \RS\Event\Manager::fire ( 'mailer.' . $this->EventId . 'beforesend', array('mailer' => $this 
		) + $this->EventParams );
