    ...
    function _init()
    {
        $this->getPropertyIterator()->append(array(
            t('Основные'),
                    ...
                    'FOLDER' => new Type\String(array(
                        'visible' => false
                    )),                    
                    'DB_INSTALL_MODE' => new Type\Integer(array(
                        'visible' => false
                    )),
                    'DB_HOST' => new Type\String(array(
                        'visible' => false
                    )),
                    'DB_NAME' => new Type\String(array(
                        'visible' => false
                    )),
                    'DB_USER' => new Type\String(array(
                        'visible' => false
                    )),
                    'DB_PASS' => new Type\String(array(
                        'visible' => false
                    )),
                    'DB_TABLE_PREFIX' => new Type\String(array(
                        'visible' => false
                    )),
                    'SECRET_KEY' => new Type\String(array(
                        'visible' => false
                    )),
                    'SECRET_SALT' => new Type\String(array(
                        'visible' => false
                    )),
                    'ADMIN_SECTION' => new Type\String(array(
                        'visible' => false
                    )),            
                    'DEFAULT_THEME' => new Type\String(array(
                        'visible' => false
                    )),
            ...
            t('Уведомления'),
                    'notice_from' => new Type\String(array(
                        'maxLength' => 255,
                    ...
                    'notice_reply' => new Type\String(array(
                        'maxLength' => 255,
                    ...
                    'smtp_host' => new Type\String(array(
                        'description' => t('SMTP сервер')
                    )),
                    'smtp_port' => new Type\String(array(
                        'description' => t('SMTP порт'),
                        'maxLength' => 10
                    )),
                    'smtp_secure' => new Type\String(array(
                    ...
                    'smtp_username' => new Type\String(array(
                        'description' => t('Имя пользователя SMTP'),
                        'maxLength' => 100
                    )),
                    'smtp_password' => new Type\String(array(
