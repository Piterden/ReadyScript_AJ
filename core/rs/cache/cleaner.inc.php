...
class Cleaner
{
	const	// Условные обозначения разных типов кэша
...
CACHE_TYPE_FULL = 'full';
	public $dirs; // Массив, содержит сведения какой в какой папке лежит тот или иной тип кэша
	public static $obj;
	...
	{
		$this->dirs = array(self::CACHE_TYPE_COMMON => array(\Setup::$CACHE_FOLDER,\Setup::$CACHE_TABLE_FOLDER 
