...
{
	private $filename;
	protected $field_name, $field_form, $root_folder, $upload_folder, // из \Setup
$upload_filename, $allow_extensions, $callback_checker, $allow_mime, $max_size;
	...
	{
		$this->setRootFolder ( \Setup::$PATH )->setUploadFolder ( $upload_folder ?  : \Setup::$TMP_REL_DIR )->setAllowExtension ( $allow_extensions ?  : array() )->setAllowMime ( $allow_mime );
	}
