...
/**
 * Менеджер блоков на странице.
 * Данный класс используется для рендеринга текущей страницы.
...
class Manager
{
	protected $view, $route_id, $main_content;
	...
	function renderLayout()
	{
		...
		$layouts = \RS\Cache\Manager::obj ()->tags ( CACHE_TAG_BLOCK_PARAM )->request ( array($this,'getLayoutData' 
		), $this->route_id, $theme_data, \RS\Site\Manager::getSiteId () );
