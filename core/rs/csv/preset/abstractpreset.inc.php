...
/**
 * Абстрактный класс набора колонок(preset'а).
 * Во время экспорта данных пресеты получают управление
...
abstract class AbstractPreset
{
	 ...
	 */
	$schema, $fields_map, $before_import_callback, $after_import_callback, $before_row_export_callback, $option_prefixes = array('set','add' 
	);
