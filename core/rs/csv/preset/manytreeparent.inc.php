...
class ManyTreeParent extends AbstractPreset
{
	...
	protected $tree_delimiter = '/', $delimiter = ";", $id_field, $link_id_field, $link_preset_id, $orm_object, $is_multisite, 
	...
	function getColumns()
	{
		return array($this->id . '-manytree' => array('key' => 'manytree','title' => $this->title 
		) 
		);
	}
