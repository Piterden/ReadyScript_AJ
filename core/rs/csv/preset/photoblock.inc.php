...
{
	protected $root = PATH, $link_id_field, $link_preset_id, $type_item;
	...
	function getColumns()
	{
		return array($this->id . '-photos' => array('key' => 'photos','title' => t ( 'Фотографии' ) 
		) 
		);
	}
	...
	function getColumnsData($n)
	{
		...
		return array($this->id . '-photos' => implode ( $value, ";\n" ) 
		);
	}
