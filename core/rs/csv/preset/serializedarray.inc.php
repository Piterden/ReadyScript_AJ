...
{
	protected $keyval_delimiter = ':', $line_delimiter = ";\n", $link_preset_id, $link_foreign_field, $title;
	function loadData()
	{
	...
	function getColumns()
	{
		return array($this->id . '-serializedarray' => array('key' => 'serializedarray','title' => $this->title 
		) 
		);
	}
