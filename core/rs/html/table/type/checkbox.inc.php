...
{
	const AUTO_WIDTH = 26, DEFAULT_CHECKBOX_NAME = 'chk[]', DEFAULT_HEAD_CLASS = ' chk';
	public $property = array('ThAttr' => array('class' => 'chk' 
	),'TdAttr' => array('class' => 'chk' 
	),'customizable' => false 
	);
	protected $name, $head_template = 'system/admin/html_elements/table/coltype/checkbox_head.tpl', $body_template = 'system/admin/html_elements/table/coltype/checkbox.tpl';
