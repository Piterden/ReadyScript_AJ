...
class Tools extends AbstractType
{
	...
	protected $tools, $head_template = 'system/admin/html_elements/table/coltype/tools_head.tpl', $body_template = 'system/admin/html_elements/table/coltype/tools.tpl';
