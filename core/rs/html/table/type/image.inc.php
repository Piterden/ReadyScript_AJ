...
{
	public $property = array('preview' => array('width' => 200,'height' => 200,'scale' => 'xy' 
	) 
	);
	protected $width, $height, $scale, $body_template = 'system/admin/html_elements/table/coltype/image.tpl';
	...
	/**
	 * Возвращает url увеличенного изображения.
	 * Если у записи нет фото, то возвращается пустая строка.
	 * 
	 * @return string
	 */
