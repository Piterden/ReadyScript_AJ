...
{
	public $work = false, $clearlink = '';
	protected $cache_items = array(), $tpl = 'system/admin/html_elements/filter/container.tpl', $sec_containers = array();
	...
	/**
	 * Очищает кэш всех элементов фильтра.
	 * Необходимо вызывать, при добавлении новых элементов фильтра
	 * 
	 * @return Container
	 */
