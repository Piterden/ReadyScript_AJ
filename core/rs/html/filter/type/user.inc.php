 ...
 * Отображается в виде поля c autocomplete.
 */
class User extends AbstractType
{
	public $tpl = 'system/admin/html_elements/filter/type/user.tpl';
	protected $request_url;
	function __construct($key, $title, $options = array())
	{
		$this->attr = array('data-deftext' => t ( 'Логин или Фамилия' ),'class' => 'w150' 
		);
