...
{
	public $pagesize_var = 'perpage', $page_var = 'p', $action, $element, $auto_fill = true, $hidden_fields = array();
	...
	function fill()
	{
		...
		\RS\Application\Application::getInstance ()->headers->addCookie ( $this->pagesize_var, $pageSize, time () + 3600 * 700 );
