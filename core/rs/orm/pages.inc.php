...
{
	private $data = array(), $query, $pagecount = 0, $current_page, $total_count, $page_size = 0, $valid = false;
	public $auto_clear = true; // Удалять из памяти не текущие страницы. Позволяет держать в памяти только одну страницу
	...
	{
		throw new RSException ( "Нельзя менять значения свойст" );
	}
	...
	{
		return $this->data[$this->current_page];
	}
	public function key()
	{
	...
	{
		return $this->valid = $this->offsetGet ( 0 );
	}
