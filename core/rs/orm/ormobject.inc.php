...
{
	protected static $self_singleton_cache = array(), $self_cache = array(); // Здесь будут кэшироваться данные объектов, загруженные через конструктор
	...
	{
		return $this->getPropertyIterator ()->append ( array('id' => new Type\Integer ( array('description' => 'Уникальный идентификатор (ID)','autoincrement' => true,'allowEmpty' => false,'primaryKey' => true,'visible' => false 
		) ) 
		) );
	}
