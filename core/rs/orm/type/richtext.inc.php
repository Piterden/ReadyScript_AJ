...
{
	protected $escape_type = self::ESCAPE_TYPE_HTML, $form_template = '%system%/coreobject/type/form/richtext.tpl';
	function formView($view_options = null)
	{
		$this->tinymce = new \RS\Html\Tinymce ( array('id' => $this->getFormName (),'name' => $this->getFormName () 
		), $this->get () );
