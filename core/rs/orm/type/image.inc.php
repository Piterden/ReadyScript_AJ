...
{
	public $preview_width = 150, $preview_height = 150, $preview_resize_type = 'xy', $form_template = '%SYSTEM%/coreobject/type/form/image.tpl', $maxLength = 255, $max_file_size = 10000000, $allow_file_types = array('image/pjpeg','image/jpeg','image/png','image/gif' 
	);
	protected $original_folder = '/storage/system/original', $preview_folder = '/storage/system/resized';
