...
{
	public $php_type = "", // mixed
$vis_form = false, $runtime = true;
	protected $form_template = '%system%/coreobject/type/form/captcha.tpl', $enabled = true;
	function __construct(array $options = null)
	{
		parent::__construct ( $options );
		$this->setChecker ( array($this,'dependCheck' 
		), 'Неверно указан код' );
	}
	...
	public function dependCheck($coreobj, $value, $errortext)
	{
		...
		return call_user_func_array ( $callback, array($coreobj,$value,'Неверно указан код' 
		) );
	}
