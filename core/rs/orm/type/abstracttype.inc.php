...
abstract class AbstractType
{
    ...
    protected
        ...
        $hint = '', //Подсказка поля
        $checkboxParam = array(),        
        $checkboxList = false, // Отображать список в виде чекбокосв
    ...
    */
    ...
    {
        return ($key === null) ? $this->checkboxParam : $this->checkboxParam[$key];
    }
