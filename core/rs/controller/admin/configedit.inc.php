...
abstract class ConfigEdit extends \RS\Controller\Admin\Front
{
	...
	function actionIndex()
	{
		...
		$this->view->assign ( array('elements' => $helper->active (),'errors' => isset ( $error ) ? $error : array() 
		) );
	...
	function helperIndex()
	{
		...
		$helper->setBottomToolbar ( new Toolbar\Element ( array('Items' => array('save' => new ToolbarButton\SaveForm (),'cancel' => new ToolbarButton\Cancel ( $this->router->getAdminUrl ( false, null, false ) ) 
		) 
		) ) );
		$helper->viewAsForm ();
		return $helper;
