...
{
	protected $default_params = array('indexTemplate' => '' 
...
;
	...
	{
		return new \RS\Orm\ControllerParamObject ( new \RS\Orm\PropertyIterator ( array('indexTemplate' => new Type\Template ( array('description' => t ( 'Шаблон' ),'attr' => array(array('data-deftext' => $this->default_params['indexTemplate'] 
		) 
		) 
		) ) 
		) ) );
