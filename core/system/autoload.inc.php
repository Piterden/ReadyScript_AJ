...
class Autoload
{
	...
	/**
	 * Устанавливает пути к каталогам с классами.
	 * Удобно применять если нужно искать классы во временных папках.
	 * 
	...
	{
		self::$require_path = array('systemClass' => \Setup::$PATH . "/core/",'moduleClass' => \Setup::$PATH . "/modules/" 
		);
	}
}
