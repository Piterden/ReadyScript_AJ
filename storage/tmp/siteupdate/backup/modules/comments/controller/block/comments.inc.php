...
class Comments extends \RS\Controller\StandartBlock
{
    ...
    function getParamObject()
    {
        return parent::getParamObject()->appendProperty(array(
            ...
            'type' => new Type\String(array(
                ...
                'list' => array(array('\Comments\Model\Api', 'getAllowTypes'))
            )),
    ...
    function actionGetCommentList()
    {
        ...
        $paginator = new \RS\Helper\Paginator($this->page, $total, $this->pageSize, \RS\Helper\Paginator::PATTERN_TEMPLATE, array(), '?cp=%PAGE%');        
