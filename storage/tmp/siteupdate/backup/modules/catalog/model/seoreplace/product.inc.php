...
{
	public $hint_fields = array( // Массив имён свойств которым будет обновлена подсказка (hint)
...
new \Catalog\Model\Orm\Product (),'cat_' => new \Catalog\Model\Orm\Dir (),'price' => 'Цена товара (по умолчанию)' 
		);
		
		$this->include_array = array( // Массив с ключами включения, какие элементы в массиве автозамены участвуют
'id','title','short_description','description','barcode','cat_name','cat_itemcount' 
		);
