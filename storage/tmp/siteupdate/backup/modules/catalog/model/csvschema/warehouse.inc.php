...
class Warehouse extends \RS\Csv\AbstractSchema
{
	...
	{
		parent::__construct ( new Preset\Base ( array('ormObject' => new \Catalog\Model\Orm\WareHouse (),'excludeFields' => array('id','site_id','image' 
		),'replaceMode' => true,'nullFields' => array('xml_id' 
