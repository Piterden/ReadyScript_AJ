    ...
    function _init()
    {
        parent::_init()->append(array(
            t('Основные'),
                    ...
                    'barcode' => new Type\String(array(
                        'maxLength' => '50',
                        'index' => true,
                        'description' => t('Артикул'),
                        'allowempty' => true,
                            )),
                    'weight' => new Type\Float(array(
                        'description' => t('Вес'),
                            )),
                    ...
                    'recommended' => new Type\String(array(
                        'maxLength' => 4000,
                    ...
                    'concomitant' => new Type\String(array(
                        'maxLength' => 4000,
            ...
            t('Комплектации'),
                    ...
                    'offer_caption' => new Type\String(array(
            ...
            t('Мета-тэги'),
                    'meta_title' => new Type\String(array(
                        'maxLength' => '1000',
                        'description' => t('Заголовок'),
                    )),
                    'meta_keywords' => new Type\String(array(
                        'maxLength' => '1000',
                        'description' => t('Ключевые слова'),
                    )),
                    'meta_description' => new Type\String(array(
                        'maxLength' => '1000',
                        'viewAsTextarea' => true,
                        'description' => t('Описание'),
                    )),
