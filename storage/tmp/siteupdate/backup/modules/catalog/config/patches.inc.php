...
class Patches extends \RS\Module\AbstractPatches
{
	...
	function init()
	{
		return array('20068','20082','200163' 
		);
	}
	...
	function afterUpdate20082()
	{
		...
		foreach($sites as $site) {
			$warehouse = \Catalog\Model\Orm\WareHouse::loadByWhere ( array('site_id' => $site['id'] 
			) );
	...
	{
		\RS\Orm\Request::make ()->update ( new \Catalog\Model\Orm\WareHouse () )->set ( 'checkout_public = public' )->exec ();
	}
}
