...
class OneClick extends \RS\Controller\Front
{
	...
	function actionIndex()
	{
		...
		$this->app->breadcrumbs->addBreadCrumb ( $product['title'], $this->router->getUrl ( 'catalog-front-product', array('id' => $product['_alias'] 
		...
		$offer_fields = array('offer' => null,'multioffer' => array() 
		);
		...
		$this->view->assign ( array('click' => $click,'offer_val' => $offer_id,'offer_fields' => $offer_fields,'oneclick_userfields' => $click_fields_manager,'product' => $product,'request' => $request,'error_fields' => $errors 
		) );
