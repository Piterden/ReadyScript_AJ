...
$controller_description = 'Выводит список всех брендов'; // Описание контроллера
	protected $default_params = array('indexTemplate' => 'blocks/brands/brands.tpl' 
	);
	...
	{
		return parent::getParamObject ()->appendProperty ( array('pageSize' => new Type\Integer ( array('description' => t ( 'Количество элементов для отображения. 0 - все' ),'default' => 0 
		) ) 
		) );
	}
	function actionIndex()
	{
		...
		$brands = $api->getBrandsForBlock ( $pageSize );
		...
		$this->view->assign ( array('brands' => $brands 
		) );
