...
{
	protected static $controller_title = 'Просмотренные раннее товары', $controller_description = 'Блок со списком просмотренных раннее товаров пользователя';
	protected $default_params = array('indexTemplate' => 'blocks/lastviewed/products.tpl', // Должен быть задан у наследника
'pageSize' => 16 
	), $products;
	public $log_api, $api;
	function getParamObject()
	{
		return parent::getParamObject ()->appendProperty ( array('pageSize' => new Type\Integer ( array('description' => t ( 'Количество отображаемых элементов' ) 
		) ) 
		) );
	}
	function init()
	...
	function actionIndex()
	{
		...
		$this->view->assign ( array('products' => $products 
		) );
