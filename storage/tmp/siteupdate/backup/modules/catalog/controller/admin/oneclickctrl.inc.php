...
/**
 * Контроллер покупки в 1 клик в админ.
 * панели
 */
class OneClickCtrl extends \RS\Controller\Admin\Crud
{
	...
	function helperIndex()
	{
		...
		) ),new TableType\String ( 'status', 'Статус', array('Sortable' => SORTABLE_BOTH,'CurrentSort' => SORTABLE_ASC 
		...
		) ),new Filter\Type\Datetime ( 'dateof', t ( 'Дата создания' ) ),new Filter\Type\Select ( 'status', t ( 'Статус' ), array('new' => 'Новый','viewed' => 'Закрыт' 
		) ) 
		) 
		) ) 
		) 
