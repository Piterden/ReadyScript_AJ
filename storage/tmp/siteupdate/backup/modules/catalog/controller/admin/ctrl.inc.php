...
class Ctrl extends \RS\Controller\Admin\Crud
{
    ...
    function helperIndex()
    {
        ...
        foreach($cost_types as $cost_type) {
            $cost_columns[] = new TableType\String('cost_'.$cost_type['id'], t('Цена ').$cost_type['title'], array(
        ...
        $helper->setTable(new Table\Element(array(
            'Columns' => array_merge(array(
                ...
                new TableType\String('id', '№', array('TdAttr' => array('class' => 'cell-sgray'), 'ThAttr' => array('width' => '50'), 'Sortable' => SORTABLE_BOTH)),
            ), 
            $cost_columns,
            array(               
                new TableType\Actions('id', array(
                    ...
                    new TableType\Action\DropDown(array(
                        ...
                        array(
                            ...
                            'attr' => array(
                                'target' => '_blank',
                                '@href' => $this->router->getUrlPattern('catalog-front-product', array(':id' => '@_alias')),
                            )
                        ),
                        array(
        ...
        $tree = new Tree\Element( array(
            ...
            'sortable' => true,
            'mainColumn' => new TableType\Usertpl('name', 'Название', '%catalog%/tree_item_cell.tpl', array(
            ...
            'inlineButtons' => array(
                ...
                'edit' => array(
                    'attr' => array(
                        ...
                        'href' => $this->router->getAdminUrl('edit_dir', array('id' => $dir)),
                ...
                'delete' => array(
                    'attr' => array(
                        'title' => t('удалить'),
                        'href' => $this->router->getAdminUrl('del_dir', array('chk[]' => $dir)),
            ...
            'Container' => new Filter\Container( array( 
                                'Lines' =>  array(
                                    new Filter\Line( array('Items' => array(
                                                            new Filter\Type\String('name','Название', array('SearchType' => '%like%', 'attr' => array('style' => 'width:300px'))),
                                                        )
                                    ))
                                ),
                            )),
                                        ...
                                        'Lines' => array(
                                            new Filter\Line( array(
                                                'Items' => array(
                                                    ...
                                                    new Filter\Type\Select('brand_id', 'Бренд', array('' => 'Любой') + \Catalog\Model\BrandApi::staticSelectList(false))
                                                )
                                            )),
                                            new Filter\Line( array(
                                                'Items' => array(
