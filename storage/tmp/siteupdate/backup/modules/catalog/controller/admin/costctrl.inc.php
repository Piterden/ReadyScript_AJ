...
use \RS\Html\Table\Type as TableType, \RS\Html\Toolbar\Button as ToolbarButton, \RS\Html\Table;
...
class CostCtrl extends \RS\Controller\Admin\Crud
{
	...
	function helperIndex()
	{
		...
		) ),new TableType\String ( '_type_text', 'Тип' ),new TableType\String ( 'id', '№', array('ThAttr' => array('width' => '50' 
		...
		) ) ),new TableType\Action\DropDown ( array(array('title' => t ( 'клонировать тип цены' ),'attr' => array('class' => 'crud-add','@href' => $this->router->getAdminPattern ( 'clone', array(':id' => '~field~' 
		) ) 
		) 
		),array('title' => t ( 'установить по умолчанию' ),'attr' => array('@data-url' => $this->router->getAdminPattern ( 'setDefaultCost', array(':id' => '@id' 
		) ),'class' => 'crud-get' 
		) 
		) 
		) ) 
