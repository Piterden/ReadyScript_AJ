...
class Robokassa extends AbstractType
{
	...
	function getFormObject()
	{
		...
		) ),'login' => new Type\String ( array('description' => t ( 'Логин' ) 
		) ),'password_1' => new Type\String ( array('description' => t ( 'Пароль #1' ) 
		) ),'password_2' => new Type\String ( array('description' => t ( 'Пароль #2' ) 
		) ),'__help__' => new Type\Mixed ( array('description' => t ( '' ),'visible' => true,'template' => '%shop%/form/payment/robokassa/help.tpl' 
		) ) 
		) );
