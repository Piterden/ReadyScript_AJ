...
class Discount extends \RS\Orm\OrmObject
{
    ...
    function _init()
    {
        parent::_init()->append(array(
            ...
            'code' => new Type\String(array(
                'maxLength' => '50',
                'description' => t('Код'),
                'Checker' => array('chkEmpty','Укажите код купона'),
            ...
            'period' => new Type\Enum(array('timelimit', 'forever'), array(
                ...
                'listFromArray' => array(array(
                    'timelimit' => 'Ограничен по времени',
                    'forever' => 'Вечный'
                ))
            )),
            ...
            'uselimit' => new Type\Integer(array(
                ...
                'hint' => 'Количество раз, которое можно использовать купон, 0 - неограниченно',
            ...
            'makecount' => new Type\Integer(array(
                ...
                'runtime' => true,
                'visible' => false,
                'hint' => 'Сгенерировать указанное число купонов с теми же параметрами, но разными кодами',
