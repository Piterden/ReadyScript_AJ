    ...
    {     
        ...
        $helper->setTable(new Table\Element(array(
            'Columns' => array(
                ...
                new TableType\String('title', t('Название'), array('Sortable' => SORTABLE_BOTH, 'href' => $this->router->getAdminPattern('edit', array(':id' => '@id') ), 'LinkAttr' => array('class' => 'crud-edit') )),
                new TableType\Usertpl('bgcolor', t('Цвет'), '%shop%/color_cell.tpl'),
                new TableType\String('id', 'ID', array('Sortable' => SORTABLE_BOTH, 'CurrentSort' => SORTABLE_ASC, 'TdAttr' => array('class' => 'cell-sgray'))),
