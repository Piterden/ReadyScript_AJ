...
{
	protected $info_title = 'Предварительные заказы', $info_description = 'Отображает список предварительных заказов';
	function actionIndex()
	{
		...
		$this->view->assign ( array('list' => $reservation_api->getList ( $page, $pageSize ),'paginator' => $paginator,'filter' => $filter 
		) );
